...
public final class CharmEffects {
    ...
    public int getSharpShadowDamage(
        int baseNailDamage
    ) {
        if (!hasSharpShadow()) {
            return 0;
