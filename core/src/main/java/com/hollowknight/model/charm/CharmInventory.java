...
public class CharmInventory {
    ...
    public CharmInventory() {
        this.notchCapacity = DEFAULT_NOTCH_CAPACITY;

        this.ownedCharms = EnumSet.noneOf(CharmType.class);

        this.equippedCharms = EnumSet.noneOf(CharmType.class);
    ...
    public boolean isOwned(CharmType charm) {
        return charm != null && ownedCharms.contains(charm);
    }

    public void unlockCharm(CharmType charm) {
        if (charm == null) {
            return;
        }
    ...
    public void unlockAllCharms() {
        ownedCharms.addAll(EnumSet.allOf(CharmType.class));
    }

    public boolean isEquipped(CharmType charm) {
        return charm != null && equippedCharms.contains(charm);
    }
    ...
    public boolean canEquip(CharmType charm) {
        ...
        return getUsedNotches() + charm.getNotchCost() <= notchCapacity;
    }
    ...
    public void setOwnedCharms(Set<CharmType> charms) {
        ownedCharms.clear();
    ...
    public void setEquippedCharms(Set<CharmType> charms) {
    ...
    public int getRemainingNotches() {
        return notchCapacity - getUsedNotches();
    }
    ...
    public Set<CharmType> getOwnedCharms() {
        return Collections.unmodifiableSet(ownedCharms);
    }
