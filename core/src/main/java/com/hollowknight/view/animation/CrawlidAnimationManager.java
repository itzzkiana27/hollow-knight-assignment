...
/**
 * Loads the Crawlid animation frames individually,
 * using the same approach as the Knight.
 */
public final class CrawlidAnimationManager {

    private static final String BASE_PATH =
        "sprites/enemies/crawlid/";

    private final EnumMap<
        CrawlidAnimationType,
