...
public class KnightAnimationManager implements Disposable {
    ...
    private final EnumSet<PlayerAnimationType>
        loopingAnimations;
    ...
    public KnightAnimationManager() {
        ...
        loopingAnimations = EnumSet.noneOf(
            PlayerAnimationType.class
        );
    ...
    private Animation<TextureRegion> createAnimation(
        ...
        Array<TextureRegion> frames = loadFrames(
            folder,
            frameCount,
            possiblePrefixes
        );
    ...
    private Array<TextureRegion> loadFrames(
        ...
        for (int index = 0;
            ...
            FileHandle frameFile = findFrameFile(
                folder,
                index,
                possiblePrefixes
            );
    ...
    private FileHandle findFrameFile(
        String folder,
        int index,
        String... possiblePrefixes
    ) {
    ...
    public TextureRegion getFrame(
        ...
        if (animation == null) {
            throw new GdxRuntimeException(
                "No Knight animation registered for: "
                    + type
            );
        }
