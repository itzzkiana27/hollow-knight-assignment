...
public class ZoteAnimationManager implements Disposable {
    ...
    public ZoteAnimationManager() {
        loadFrames(
            idleTextures,
            "sprites/effects/npc/zote/idle/idle_",
            5
        );

        loadFrames(
            talkTextures,
            "sprites/effects/npc/zote/talk/talk_",
            5
        );

        loadFrames(
            attackTextures,
            "sprites/effects/npc/zote/attack/attack_",
            4
        );
    }
