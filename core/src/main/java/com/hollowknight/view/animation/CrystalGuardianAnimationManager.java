...
public final class
CrystalGuardianAnimationManager {

    private static final String BASE_PATH =
        "sprites/enemies/crystal_guardian/";
    ...
    public CrystalGuardianAnimationManager() {
        animations = new EnumMap<>(
            CrystalGuardianAnimationType.class
        );
    ...
    public TextureRegion getFrame(
        CrystalGuardianAnimationType type,
        float animationTime
    ) {
        Animation<TextureRegion> animation =
            animations.get(type);
        ...
        if (animation == null) {
            throw new IllegalArgumentException(
                "Missing Crystal Guardian animation: "
                    + type
            );
        }
