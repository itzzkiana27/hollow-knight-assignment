...
public final class PlayerMovement {
    ...
    public boolean updateDash(
        ...
        // Gravity intentionally remains paused during dash.
    ...
    /**
     * Handles normal jump, double jump, and wall jump input.
     *
    ...
    public boolean handleJumpInput(
        ...
        int heldWallSide =
            getHeldWallSide(input, maximumX);
    ...
    private void startWallJump(
        ...
        // One double jump remains available after a wall jump.
        jumpsUsed = 1;
    ...
    /**
     * Called after a successful downward nail hit on a spike or enemy.
     *
     * This implements the model-side pogo result required by the assignment:
     * bounce upward, refresh the one air dash, and leave one double jump
     * available after the bounce. The collision check itself will be added
     * in the combat/collision step.
     */
    public void pogoBounce() {
        ...
        /*
         * One double jump remains available after pogo.
         */
        jumpsUsed = 1;

        /*
         * Pogo resets the air dash restriction.
         */
        dashCooldownRemaining = 0f;
        dashTimeRemaining = 0f;
